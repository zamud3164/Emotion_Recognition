...
df = pd.read_csv('data/audio_features_gan_v0.csv')
...
X_train.to_csv('data/audio_train_gan_v0.csv', index=False)
X_test.to_csv('data/audio_test_gan_v0.csv', index=False)
