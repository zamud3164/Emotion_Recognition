...
df = pd.read_csv('source/generated_audio/data/audio_features_gan_v0.csv')
...
X_train.to_csv('source/generated_audio/data/audio_train_gan_v0.csv', index=False)
X_test.to_csv('source/generated_audio/data/audio_test_gan_v0.csv', index=False)
